...
5. Read the finished front page beside the verdict, then keep the 1600 × 2000 PNG. Its layout is chosen by your crop: a wide cut runs as a banner, a tight cut as a tall column. The artifact also records the selected lead, press reading, exact plate code, and the City Heat your filing drew. Then continue through the closing frame and open the issue wall.
...
5. **Reveal, closing frame, and archive:** The exact flattened `dataUrl` appears inside a complete on-screen front page, the downloadable 1600 × 2000 keepsake, the angle-specific closing-frame overlay, and the issue wall. The front page carries the story headline, deck, lead, press reading, plate receipt, and City Heat around the visitor's untouched pixels. The raw-plate download uses that same export and its returned image format.
