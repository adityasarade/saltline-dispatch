...
| `public/saltline-dispatch.gif` | Captured from the local Saltline prototype on 4 September 2026 | Team-created product demonstration | Five original interface states: desk, field calls, Angle Lock editor, printed dispatch, and issue wall. |
