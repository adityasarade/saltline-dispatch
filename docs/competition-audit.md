...
| Experience | Direct case access, explicit Angle Lock, three-tool routes, protected dirty drafts, measured loader, angle-specific consequence, and replayable archive. | A 3 to 5 minute interaction is longer than a static demo, so the README GIF must communicate the loop quickly. |
